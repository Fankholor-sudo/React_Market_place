...
function Search(){
    ...
    return (
        <div className="search">
            <div className="input">{/* onClick={RenderSearch(items)} */}
                <input data-testid='btn' type = "text" placeholder = "Search...." onChange={(event) => setSearchValue(event.target.value)} value={searchValue} /></div>
                <div><button className="find"><img className="icons" src="./icons/search.png" alt="search" /></button ></div>
        </div>
    );
}    
